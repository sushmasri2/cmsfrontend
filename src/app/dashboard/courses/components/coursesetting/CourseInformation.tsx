        ...
        <div className="px-5 py-3">
            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
                <div>
                    <ValidatedInput
                        ...
                        value={typeof formData.course_name === "string" ? formData.course_name : (formData?.course_name || "")}
                ...
                <div>
                    <ValidatedInput
                        ...
                        value={typeof formData.course_card_title === "string" ? formData.course_card_title : (formData?.course_card_title || "")}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                            const value = e.target.value;
                ...
                <div>
                    <ValidatedInput
                        ...
                        label="Title"
                        placeholder="Title"
                        value={typeof formData.title === "string" ? formData.title : (formData?.title || "")}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                            const value = e.target.value;
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                    <ValidatedTextarea
                        ...
                        value={typeof formData.one_line_description === "string" ? formData.one_line_description : (formData?.one_line_description || "")}
                ...
                <div>
                    <ValidatedTextarea
                        ...
                        value={typeof formData.short_description === "string" ? formData.short_description : (formData?.short_description || "")}
            ...
            <div className="mb-4">
                <ValidatedTextarea
                    ...
                    value={typeof formData.description === "string" ? formData.description : (formData?.description || "")}
