...
export default function CourseAdministration({
    formData, data, actions, onInputChange }: CourseAdministrationProps) {
        ...
        <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <ValidatedInput
                        className="px-3 py-2"
                        value={typeof formData.version === 'string' ? formData.version : (typeof formData?.version === 'string' ? formData.version : "")}
                ...
                <div>
                    ...
                    <ValidatedInput
                        className="px-3 py-2"
                        value={formData.kite_id?.toString() || formData?.kite_id?.toString() || ""}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                            const value = e.target.value;
                ...
                <div>
                    ...
                    <ValidatedInput
                        className="px-3 py-2"
                        value={typeof formData.course_zoho_id === 'string' ? formData.course_zoho_id : (typeof formData?.course_zoho_id === 'string' ? formData.course_zoho_id : "")}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                            const value = e.target.value;
                ...
                <div>
                    ...
                    <ValidatedInput
                        className="px-3 py-2"
                        value={typeof formData.duration === 'string' ? formData.duration : (typeof formData?.duration === 'string' ? formData.duration : "")}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                            const value = e.target.value;
