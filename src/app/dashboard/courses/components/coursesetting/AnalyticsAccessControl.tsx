            ...
            <div className="grid grid-cols-4 gap-4">
                <div>
                    <ValidatedInput
                        ...
                        label="Rating"
                        value={typeof formData?.rating === 'string' ? formData.rating : (formData ? String(formData.rating) : "")}
                ...
                <div>
                    <ValidatedInput
                        ...
                        className="mb-4 px-3 py-0"
                        label="Rating Count"
                        value={typeof formData?.rating_count === 'string' ? formData.rating_count : (formData ? String(formData.rating_count) : "")}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                            const value = e.target.value;
                ...
                <div>
                    <ValidatedInput
                        ...
                        type="text"
                        className="mb-4 px-3 py-0"
                        value={typeof formData?.active_learners === 'string' ? formData.active_learners : (formData ? String(formData.active_learners) : "")}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                            const value = e.target.value;
                ...
                <div>
                    <ValidatedInput
                        ...
                        type="text"
                        className="mb-4 px-3 py-0"
                        value={typeof formData?.cpd_points === 'string' ? formData.cpd_points : (formData ? String(formData.cpd_points) : "")}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                            const value = e.target.value;
                ...
                <div>
                    ...
                    <Select2
                        ...
                        value={typeof formData?.no_price === 'string' ? formData.no_price : (formData ? String(formData.no_price) : '')}
                        onChange={(val: string | string[]) => {
                            if (typeof val === 'string' && (val === '1' || val === '0')) {
