...
## CACHE
This project implements an enhanced caching mechanism with automatic cache invalidation for improved performance and data consistency. The following components have been updated to utilize this caching strategy:

✅ Cache TTL Updated to 60 seconds
✅ Automatic Cache Invalidation on Data Mutations

#### Updated Components:
- Courses page - uses enhanced caching with auto-invalidation
- CreateCourse component - integrated with cache invalidation
- Categories page - set up global cache instance
- Course Types settings - set up global cache instance
- Category form - set up global cache instance
...
docker run -p 4000:4000 cms-ui-app
```
